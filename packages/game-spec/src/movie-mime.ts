...
export const movieMimeSetupSchema = z
  .object({
    ...
    teams: z
      ...
      .max(4)
      .default([
        { name: "The Spotlights", color: "#6c42f5" },
        { name: "The Clapboards", color: "#ff6b4a" },
      ]),
  })
...
export const movieCatalog: readonly MovieCatalogEntry[] = [
  { id: "back_to_the_future", title: "Back to the Future", year: 1985, genres: ["science_fiction", "comedy"], audience: "family", difficulty: "easy" },
  { id: "the_lion_king", title: "The Lion King", year: 1994, genres: ["animation", "family"], audience: "family", difficulty: "easy" },
  ...
  { id: "jaws", title: "Jaws", year: 1975, genres: ["thriller", "horror"], audience: "general", difficulty: "easy" },
  { id: "ghostbusters", title: "Ghostbusters", year: 1984, genres: ["comedy", "fantasy"], audience: "family", difficulty: "easy" },
  ...
  { id: "home_alone", title: "Home Alone", year: 1990, genres: ["comedy", "family"], audience: "family", difficulty: "easy" },
  { id: "harry_potter", title: "Harry Potter and the Philosopher’s Stone", year: 2001, genres: ["fantasy", "adventure"], audience: "family", difficulty: "easy" },
  { id: "finding_nemo", title: "Finding Nemo", year: 2003, genres: ["animation", "family"], audience: "family", difficulty: "easy" },
  ...
  { id: "indiana_jones", title: "Raiders of the Lost Ark", year: 1981, genres: ["adventure", "action"], audience: "family", difficulty: "medium" },
  ...
  { id: "up", title: "Up", year: 2009, genres: ["animation", "adventure"], audience: "family", difficulty: "medium" },
  { id: "inside_out", title: "Inside Out", year: 2015, genres: ["animation", "family"], audience: "family", difficulty: "medium" },
  { id: "frozen", title: "Frozen", year: 2013, genres: ["animation", "musical"], audience: "family", difficulty: "easy" },
  { id: "moana", title: "Moana", year: 2016, genres: ["animation", "adventure"], audience: "family", difficulty: "easy" },
  { id: "pirates_caribbean", title: "Pirates of the Caribbean", year: 2003, genres: ["adventure", "fantasy"], audience: "family", difficulty: "easy" },
  { id: "karate_kid", title: "The Karate Kid", year: 1984, genres: ["sport", "drama"], audience: "family", difficulty: "medium" },
  { id: "et", title: "E.T. the Extra-Terrestrial", year: 1982, genres: ["science_fiction", "family"], audience: "family", difficulty: "easy" },
  ...
  { id: "amelie", title: "Amélie", year: 2001, genres: ["romance", "comedy"], audience: "general", difficulty: "medium" },
  { id: "intouchables", title: "Intouchables", year: 2011, genres: ["comedy", "drama"], audience: "general", difficulty: "easy" },
  { id: "the_fifth_element", title: "The Fifth Element", year: 1997, genres: ["science_fiction", "action"], audience: "general", difficulty: "medium" },
  ...
  { id: "the_lord_rings", title: "The Lord of the Rings", year: 2001, genres: ["fantasy", "adventure"], audience: "family", difficulty: "easy" },
  { id: "gladiator", title: "Gladiator", year: 2000, genres: ["action", "drama"], audience: "general", difficulty: "easy" },
  { id: "the_godfather", title: "The Godfather", year: 1972, genres: ["crime", "drama"], audience: "general", difficulty: "medium" },
  ...
  { id: "groundhog_day", title: "Groundhog Day", year: 1993, genres: ["comedy", "fantasy"], audience: "general", difficulty: "medium" },
  { id: "the_terminal", title: "The Terminal", year: 2004, genres: ["comedy", "drama"], audience: "family", difficulty: "medium" },
  { id: "cast_away", title: "Cast Away", year: 2000, genres: ["adventure", "drama"], audience: "general", difficulty: "easy" },
  { id: "the_martian", title: "The Martian", year: 2015, genres: ["science_fiction", "comedy"], audience: "general", difficulty: "medium" },
  { id: "night_museum", title: "Night at the Museum", year: 2006, genres: ["comedy", "family"], audience: "family", difficulty: "easy" },
  { id: "men_in_black", title: "Men in Black", year: 1997, genres: ["science_fiction", "comedy"], audience: "family", difficulty: "easy" },
  { id: "the_incredibles", title: "The Incredibles", year: 2004, genres: ["animation", "action"], audience: "family", difficulty: "easy" },
  ...
  { id: "zootopia", title: "Zootopia", year: 2016, genres: ["animation", "comedy"], audience: "family", difficulty: "medium" },
  ...
  { id: "the_devil_wears_prada", title: "The Devil Wears Prada", year: 2006, genres: ["comedy", "drama"], audience: "general", difficulty: "medium" },
  { id: "school_of_rock", title: "School of Rock", year: 2003, genres: ["comedy", "musical"], audience: "family", difficulty: "easy" },
  { id: "paddington", title: "Paddington", year: 2014, genres: ["family", "comedy"], audience: "family", difficulty: "easy" },
  { id: "the_wizard_oz", title: "The Wizard of Oz", year: 1939, genres: ["fantasy", "musical"], audience: "family", difficulty: "medium" },
  { id: "singin_in_rain", title: "Singin’ in the Rain", year: 1952, genres: ["musical", "comedy"], audience: "family", difficulty: "hard" },
];

const genreLabels: Record<MovieGenre, string> = {
  action: "Action", adventure: "Adventure", animation: "Animation", comedy: "Comedy", crime: "Crime", drama: "Drama", family: "Family", fantasy: "Fantasy", horror: "Horror", musical: "Musical", romance: "Romance", science_fiction: "Science fiction", sport: "Sport", thriller: "Thriller",
};
...
export function createMovieMimeSpec(packInput: MimeFilmPack): ComposedGameSpec {
  ...
  const suffix = numberHash(`captain-loop-v2-en:${pack.themeId}:${pack.films.map((film) => film.id).join(":")}`).toString(36);
  const spec: ComposedGameSpec = {
    ...
    description: pack.preferences
      ...
      : "Teams act out movies without speaking or writing.",
    theme,
    ...
    decks: [{
      ...
      cards: pack.films.map((film) => ({
        id: film.id,
        title: film.title,
        body: `${film.year} · ${film.genres.map((genre) => genreLabels[genre]).join(" · ")} · ${film.difficulty} difficulty`,
        icon: genreIcons[film.genres[0] ?? "drama"],
        tags: film.genres,
      })),
    }],
    components: [
      { id: "game_header", kind: "header", audience: "public", eyebrow: "BoardForge Original", title: { kind: "literal", value: "CineMimes" }, description: { kind: "literal", value: "One secret movie, one performer, one team racing to name it." }, icon: "🎬" },
      { id: "film_deck", kind: "deck", audience: "active_player", deckId: "films", label: "Secret movie" },
      { id: "film_prompt", kind: "prompt", audience: "active_player", category: "Act it out without speaking", prompt: { kind: "active_card", deckId: "films", field: "title" }, hint: { kind: "active_card", deckId: "films", field: "body" }, icon: "🎭" },
      { id: "mime_timer", kind: "timer", audience: "public", seconds: 60, label: "Time remaining" },
      { id: "turn", kind: "turn", audience: "public" },
      { id: "round", kind: "round", audience: "public", label: "Movie" },
      { id: "teams", kind: "teams", audience: "public" },
      { id: "scores", kind: "scores", audience: "public", title: "Team box office" },
      { id: "outcome", kind: "outcome", audience: "public", title: { kind: "literal", value: "That is a wrap!" }, description: { kind: "literal", value: "The team with the most correct movies wins." } },
    ],
    actions: [
      { id: "select_mimer", label: "Choose the performer", kind: "select_player", actor: "team_captain", oncePerPhase: true, effects: [{ kind: "set_active_player", mode: "selected" }, { kind: "advance_phase" }] },
      { id: "draw_film", label: "Reveal my movie", kind: "draw", actor: "active_player", oncePerPhase: true, deckId: "films", effects: [{ kind: "draw_cards", deckId: "films", count: 1, target: "actor" }, { kind: "advance_phase" }] },
      { id: "film_guessed", label: "Movie guessed", kind: "complete_challenge", actor: "active_player", oncePerPhase: true, effects: [{ kind: "add_score", target: "actor_team", amount: 1 }, { kind: "discard_selected_card", deckId: "films", target: "actor" }, { kind: "advance_round", resetPhaseActions: true }, { kind: "set_active_player", mode: "next_team_captain" }, { kind: "advance_phase" }] },
      { id: "film_passed", label: "Pass", kind: "advance", actor: "active_player", oncePerPhase: true, effects: [{ kind: "discard_selected_card", deckId: "films", target: "actor" }, { kind: "advance_round", resetPhaseActions: true }, { kind: "set_active_player", mode: "next_team_captain" }, { kind: "advance_phase" }] },
    ],
    rules: [
    ...
    phases: [
      { id: "select_mimer", title: "The captain chooses", componentIds: ["game_header", "round", "turn", "teams", "scores"], actionIds: ["select_mimer"], nextPhaseId: "draw", completionMode: "manual", completionConditions: [], onComplete: [] },
      { id: "draw", title: "The next movie", componentIds: ["game_header", "round", "turn", "teams", "scores", "film_deck"], actionIds: ["draw_film"], nextPhaseId: "mime", completionMode: "manual", completionConditions: [], onComplete: [] },
      { id: "mime", title: "Lights, camera, mime!", componentIds: ["game_header", "round", "turn", "teams", "scores", "mime_timer", "film_prompt"], actionIds: ["film_guessed", "film_passed"], nextPhaseId: "select_mimer", completionMode: "manual", completionConditions: [], onComplete: [] },
    ],
  };
